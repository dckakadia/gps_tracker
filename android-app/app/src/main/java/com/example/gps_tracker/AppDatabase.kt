...
abstract class AppDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        // v3 → v4: add isDerivedSpeed flag for points where GPS speed was computed from coordinates.
        private val MIGRATION_3_4 = object : Migration(3, 4) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.execSQL("ALTER TABLE offline_locations ADD COLUMN isDerivedSpeed INTEGER NOT NULL DEFAULT 0")
            }
        }
