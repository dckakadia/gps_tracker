...
class ApiService {
  ...
  static Future<Map<String, dynamic>> createUser(String token, String name, String email, String password) async {
    final response = await http.post(
      Uri.parse('$baseUrl/admin/users'),
  ...
  static Future<Map<String, dynamic>> updateUser(String token, int id, String name, String email) async {
